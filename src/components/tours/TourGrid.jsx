  ...
  if (!tours || tours.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center px-4">
        ...
        <h3 className="text-2xl font-bold text-[#163a58] mb-2">Henüz Tur Bulunamadı</h3>
        <p className="text-gray-500 max-w-md">
          Aradığınız kriterlere uygun tur şu an mevcut değil veya henüz eklenmemiş. 
          Yeni rotalarımız hazırlanıyor, takipte kalın.
        </p>
      </div>
    );
  }
