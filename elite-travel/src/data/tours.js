...
// Tours datası i18n'den yükleniyor
export const getTours = () => {
  const lang = i18n.language || 'tr';
  const toursData = i18n.getResourceBundle(lang, 'tours');
  return toursData?.tours || [];
};

// Fallback/varsayılan tours (i18n yüklenemezse)
export const tours = [
