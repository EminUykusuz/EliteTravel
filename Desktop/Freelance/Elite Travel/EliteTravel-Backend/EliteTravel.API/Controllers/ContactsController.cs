...
namespace EliteTravel.API.Controllers
{
    ...
    {
        private readonly IService<Contact, ContactDto> _service;

        public ContactsController(IService<Contact, ContactDto> service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Save(ContactDto dto)
        {
